...
function editable_page() {
	// creating (registering) the custom type
	register_post_type( 'editable_page', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Editable Pages', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Editable Page', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Editable Pages', 'jointswp'), /* the all items menu item */
			'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
			'add_new_item' => __('Add New Editable Page', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Editable Page', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Editable Page', 'jointswp'), /* New Display Title */
			'view_item' => __('View Editable Page', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Editable Pages', 'jointswp'), /* Search Custom Type Title */
			'not_found' =>  __('Nothing found in the Database.', 'jointswp'), /* This displays if there are no entries yet */
			'not_found_in_trash' => __('Nothing found in Trash', 'jointswp'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			
			'description' => __( 'This is a custom page/post type for client editability', 'jointswp' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'page', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'editable_posts', /* you can rename the slug here */
			'capability_type' => 'page',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
			'supports' => array( 'title', 'custom-fields', 'revisions', 'sticky'),
...
function na_remove_slug( $post_link, $post, $leavename ) {
  if ( 'editable_page' != $post->post_type || 'publish' != $post->post_status ) {
    return $post_link;
  }
...
function na_parse_request( $query ) {
  ...
  if ( ! empty( $query->query['name'] ) ) {
      $query->set( 'post_type', array( 'post', 'editable_page', 'page' ) );
  }
}
